...
export const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-24 bg-dark-900/40 border-b border-dark-800/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((item, idx) => (
            <div
              key={idx}
              className="p-8 rounded-2xl bg-dark-950 border border-dark-800/90 hover:border-gold-500/30 transition-all flex flex-col justify-between"
            >
              <div>
                <Quote className="w-8 h-8 text-gold-500/40 mb-5" />
              ...
              <div className="pt-6 border-t border-dark-850">
                ...
                <div className="font-editorial text-base font-semibold text-slate-100">
                  {item.author}
                </div>
